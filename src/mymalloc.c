...
void * myMalloc( long size )
{
    ...
    if( tmpUk != NULL ) {
        ...
        alokaceCelkem += size;
        printf( "myMalloc: allocating %ld bytes, total allocated %ld bytes\n", size, alokaceCelkem );
    }
...
void myFree( void * memblock )
{
    ...
    if( memblock != NULL ) {
        ...
        alokaceCelkem -= size;
        printf( "myFree: releasing %ld bytes, total allocated %ld bytes\n", size, alokaceCelkem );
    }
